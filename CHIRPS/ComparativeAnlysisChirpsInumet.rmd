...
```{r corrplot}
#ggplot of the correlation of INUMET station X1 against all CHIRPS data
ggplot(result, aes(x=Long, y=Lat))+ geom_point(aes(colour=X1)) +
  scale_color_gradientn(colours=rainbow(5))

```

The plot shows the correlation between one INUMET station, the station X1, and all CHIRPS data of the catchment. The correlation values are varying from 0.72 to 0.77 accross the catchment.      
