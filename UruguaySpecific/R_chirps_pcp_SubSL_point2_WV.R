...
plot(chirps_inumet_pt2$prcp_chirps,chirps_inumet_pt2$prcp_inumet, xlab="inumet prcp (mm)", ylab = "chirps prcp(mm)", xlim =c(0,150), ylim=c(0,150))
...
plot(FDC_gen(chirps_inumet_pt2$prcp_chirps)$rainfall,
     FDC_gen(chirps_inumet_pt2$prcp_inumet)$rainfall, xlim=c(0,100), ylim=c(0,100))
lines(c(0,100),c(0,100), lty=2)
...
### FM: it gave me an error when running chirps_pentad
