...
setwd("C:/Users/User/Desktop/Output HRU SWAT")
...
r$anu
r$mon
plot(r$mon$ET, type="l")

## read the daily output.hru data from QSWAT
setwd("C:/Users/User/Desktop/Output HRU SWAT")  #set your own directory
fileDaily<- "output_QSWAT_daily.hru"

r <- swat_readOutputhru(fileDaily,col=w)
head(r)
head(r$res)

Dates <- seq.Date(as.Date("2004-01-01"), as.Date("2016-12-31"), by =1)
plot(r$res$ET,type="l")

#Analyzing one HRU (HRU =5) from QSWAT
require(zoo)
r <- swat_readOutputhru(fileDaily,col=w,hru=5)
OneHRU <- zoo(r$res, order.by =  Dates)
plot(time(OneHRU),OneHRU$ET, type="l")
head(OneHRU)
names(OneHRU)
